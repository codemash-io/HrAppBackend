...
namespace HrApp
{
    public class WordCreator
    {
        ...
        public async Task GenerateWordAsync( EmployeeEntity employee, string reason, AbsenceRequestEntity absenceRequest, string end, string absenceType, string days)
        {
            ...
            var document = FormatWordDocument(fileName, absenceRequest.AbsenceStart, absenceRequest.AbsenceEnd, employee, reason, end, absenceType,days);
        ...
        private DocumentCore FormatWordDocument(string filePath, DateTime dateFrom, DateTime dateTo, EmployeeEntity employee, string reason, string end, string absenceType, string days)
        {          
