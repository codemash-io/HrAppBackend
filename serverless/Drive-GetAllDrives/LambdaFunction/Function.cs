...
namespace LambdaFunction
{
    public class Function
    {
        ...
        /// <returns></returns>
        public async Task<List<Drive>> Handler(CustomEventRequest<BasicInput> lambdaEvent, ILambdaContext context)
        {
            string type, typeId;
            string expand, select, skipToken, top, orderBy;
            ...
            var drives = await graphFileRepo.ListAllDrives(type, typeId, expand, select, 
                skipToken, top, orderBy);
